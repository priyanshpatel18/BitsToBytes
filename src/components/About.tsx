        ...
        <div className="w-full bg-[#42B6E3] flex flex-col items-center py-[2rem] lg:py-[4rem]">
            ...
            <div className="flex flex-col lg:flex-row w-[90%] gap-[2rem] items-center justify-between overflow-hidden">
                <div className="text-center w-full lg:w-[50%] px-[2rem]">
                    ...
                    >
                        Being a programming club, we assure pretty much
                        everything you ask for! From inspiring events and
                        workshops to captivating lectures and talks, as well as
                        iconic hackathons and coding contests well known for
                        encouraging innovation and pushing limits. Our community
                        of like-minded individuals is always willing to lend a
